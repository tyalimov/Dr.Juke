...
#define TRACE_REGFILTER_INFO	0x00000004
#define TRACE_REGFILTER_ERROR	0x00000008
#define TRACE_PREF				0x00000010
#define TRACE_FSFILTER			0x00000020
#define TRACE_OS_VER			0x00000040
#define TRACE_LOAD				0x00000080

#define TRACE_ALL (	TRACE_NONE \
	| TRACE_INFO \
	| TRACE_ERROR \
	| TRACE_REGFILTER_INFO \
	| TRACE_REGFILTER_ERROR \
	| TRACE_LOAD)
